...
from odoo.addons.report_xlsx.report.report_partner_xlsx import PartnerXlsx
...
class AccountLedger(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, record):
        ...
        #pour ajouter la format de chque ligne excel
        ...
        worksheet = workbook.add_worksheet("Account Ledger Report")
        ...
        #écrire en work sheet selon le filtre des dates
        ...
        #si tout le filtre est remplis ( date_from + date_to)
        row += 1
